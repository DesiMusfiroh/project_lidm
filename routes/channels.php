...
Broadcast::channel('chatKelompok', function ($user) { 
    return $user;
});
Broadcast::channel('startDiskusiChannel.{kelas_id}', function ($kelas, $kelas_id) {
    return true;
});
Broadcast::channel('endDiskusiChannel.{kelas_id}', function ($kelas, $kelas_id) {
    return true;
});
